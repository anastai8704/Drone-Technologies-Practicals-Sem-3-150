...
void plutoLoop ( void ) {
  static Interval monitorInterval;

  if ( monitorInterval.set ( 1000, true ) ) {
    Monitor_Print ( "Time (ms): ", ( double ) millis ( ), 0 );
    Monitor_Println ( " | Z velocity: ", ( int ) Estimate_Get ( Velocity, Z ) );
  }
}
