...
void plutoLoop ( void ) {
  Monitor_Println ( "Roll: ", Estimate_Get ( Angle, AG_ROLL ) / 10.0, 1 );
  Monitor_Println ( "Pitch: ", Estimate_Get ( Angle, AG_PITCH ) / 10.0, 1 );
  Monitor_Println ( "Yaw: ", Estimate_Get ( Angle, AG_YAW ), 1 );
  Monitor_Println ( "Roll rate: ", ( int32_t ) Sensor_Get ( Gyroscope, X ) );
  Monitor_Println ( "Pitch rate: ", ( int32_t ) Sensor_Get ( Gyroscope, Y ) );
  Monitor_Println ( "Yaw rate: ", ( int32_t ) Sensor_Get ( Gyroscope, Z ) );
}
