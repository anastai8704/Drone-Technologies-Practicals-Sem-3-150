...
void plutoLoop ( void ) {
  int16_t height = Estimate_Get ( Position, Z );
  int16_t verticalVelocity = Estimate_Get ( Velocity, Z );

  Monitor_Println ( "Height (cm):", height );
  Monitor_Println ( "Vertical velocity (cm/s):", verticalVelocity );
}
